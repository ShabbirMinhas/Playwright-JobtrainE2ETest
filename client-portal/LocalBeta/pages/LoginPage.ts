...
export default class LoginPage {
    ...
    constructor(page: Page) {
        ...
        this.selectors = {
            ...
            usernameInput: 'inputEmail',// Use getByTestId
            passwordInput: 'inputPassword',// Use getByTestId
            loginButton: 'Login',// Use getByRole(button)
            ...
            jtAdminLink: 'RightSideMenu',//Use getByTestId
            logOutButton: 'logout',// Use getByTestId
        };
    }
    ...
    async clickOnLoginButton() {
        ...
        await this.page.getByText(this.selectors.loginButton).click();
