...
import SearchPageCandidateKeyword from "../../pages/search-pages/SearchPageCandidateKeyword";
...
test.beforeEach(async ({ page }) => {
  await page.goto("Search/Keyword", {
...
test("Filter by tabs and check the visibility of all the filters", async ({
  ...
  const search = new SearchPageCandidateKeyword(page);
  await page.waitForLoadState("networkidle");
